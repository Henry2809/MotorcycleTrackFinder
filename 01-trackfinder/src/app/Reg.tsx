...
export default function Registration({ onRegister }: RegistrationProps) {
        ...
        return (
          <div className="flex items-center justify-center min-h-screen bg-fixed bg-cover" 
          style={{
                backgroundImage: "url(/background2.jpg)"
              }}
                >
                <div className="absolute inset-0 bg-black bg-opacity-40 z-10"></div>
            <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-md relative z-20 bottom-10">
